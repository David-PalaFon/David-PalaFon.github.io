...
import { AuthorProfile2Component } from "./components/author-profile2/author-profile2.component";
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      { path: "", component: NewIndexComponent, pathMatch: "full" },
      ...
      { path: "**", component: NewIndexComponent },
    ]),
  ],
